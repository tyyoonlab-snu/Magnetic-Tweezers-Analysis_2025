function [B, B2] = mk_mhmm_obs_mat(data, mu, Sigma, mixmat)
% MK_MHMM_OBS_MAT Make the sequence-specific observation matrix for a mixture-of-Gaussian HMM.
% [B, B2] = mk_chmm_obs_mat(data, mu, Sigma, mixmat)
%
% Inputs:
